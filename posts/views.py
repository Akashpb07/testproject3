...
from stories.models import Stories , institute_deatil , feature , why_choose_learning_point, ourcard ,author ,our_course ,add_review ,contact_us_detail
...
class IndexView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        institue = institute_deatil.objects.all()
        whychoose = why_choose_learning_point.objects.all()
        cards = ourcard.objects.all()
        authors = author.objects.all()
        courses = our_course.objects.all()
        reviews = add_review.objects.all().order_by('id')[:13]
        context = {
